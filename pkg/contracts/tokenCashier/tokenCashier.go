...
// ITokenListABI is the input ABI used to generate the binding from.
const ITokenListABI = "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"isAllowed\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"maxAmount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"minAmount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"

// ITokenListFuncSigs maps the 4-byte function signature to its string representation.
var ITokenListFuncSigs = map[string]string{
	"babcc539": "isAllowed(address)",
	"94dee0a4": "maxAmount(address)",
	"4d0a32db": "minAmount(address)",
}

// ITokenList is an auto generated Go binding around an Ethereum contract.
type ITokenList struct {
	ITokenListCaller     // Read-only binding to the contract
	ITokenListTransactor // Write-only binding to the contract
	ITokenListFilterer   // Log filterer for contract events
}

// ITokenListCaller is an auto generated read-only Go binding around an Ethereum contract.
type ITokenListCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ITokenListTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ITokenListTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ITokenListFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ITokenListFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ITokenListSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ITokenListSession struct {
	Contract     *ITokenList       // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// ITokenListCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ITokenListCallerSession struct {
	Contract *ITokenListCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts     // Call options to use throughout this session
}

// ITokenListTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ITokenListTransactorSession struct {
	Contract     *ITokenListTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts     // Transaction auth options to use throughout this session
}

// ITokenListRaw is an auto generated low-level Go binding around an Ethereum contract.
type ITokenListRaw struct {
	Contract *ITokenList // Generic contract binding to access the raw methods on
}

// ITokenListCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ITokenListCallerRaw struct {
	Contract *ITokenListCaller // Generic read-only contract binding to access the raw methods on
}

// ITokenListTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ITokenListTransactorRaw struct {
	Contract *ITokenListTransactor // Generic write-only contract binding to access the raw methods on
}

// NewITokenList creates a new instance of ITokenList, bound to a specific deployed contract.
func NewITokenList(address common.Address, backend bind.ContractBackend) (*ITokenList, error) {
...
// NewITokenListCaller creates a new read-only instance of ITokenList, bound to a specific deployed contract.
func NewITokenListCaller(address common.Address, caller bind.ContractCaller) (*ITokenListCaller, error) {
...
// NewITokenListTransactor creates a new write-only instance of ITokenList, bound to a specific deployed contract.
func NewITokenListTransactor(address common.Address, transactor bind.ContractTransactor) (*ITokenListTransactor, error) {
...
// NewITokenListFilterer creates a new log filterer instance of ITokenList, bound to a specific deployed contract.
func NewITokenListFilterer(address common.Address, filterer bind.ContractFilterer) (*ITokenListFilterer, error) {
	contract, err := bindITokenList(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ITokenListFilterer{contract: contract}, nil
}

// bindITokenList binds a generic wrapper to an already deployed contract.
func bindITokenList(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
...
// returns.
func (_ITokenList *ITokenListRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ITokenList.Contract.ITokenListCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ITokenList *ITokenListRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ITokenList.Contract.ITokenListTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ITokenList *ITokenListRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ITokenList.Contract.ITokenListTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ITokenList *ITokenListCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ITokenList.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ITokenList *ITokenListTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ITokenList.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ITokenList *ITokenListTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ITokenList.Contract.contract.Transact(opts, method, params...)
}

// IsAllowed is a paid mutator transaction binding the contract method 0xbabcc539.
//
// Solidity: function isAllowed(address ) returns(bool)
func (_ITokenList *ITokenListTransactor) IsAllowed(opts *bind.TransactOpts, arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.contract.Transact(opts, "isAllowed", arg0)
}

// IsAllowed is a paid mutator transaction binding the contract method 0xbabcc539.
//
// Solidity: function isAllowed(address ) returns(bool)
func (_ITokenList *ITokenListSession) IsAllowed(arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.Contract.IsAllowed(&_ITokenList.TransactOpts, arg0)
}

// IsAllowed is a paid mutator transaction binding the contract method 0xbabcc539.
//
// Solidity: function isAllowed(address ) returns(bool)
func (_ITokenList *ITokenListTransactorSession) IsAllowed(arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.Contract.IsAllowed(&_ITokenList.TransactOpts, arg0)
}

// MaxAmount is a paid mutator transaction binding the contract method 0x94dee0a4.
//
// Solidity: function maxAmount(address ) returns(uint256)
func (_ITokenList *ITokenListTransactor) MaxAmount(opts *bind.TransactOpts, arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.contract.Transact(opts, "maxAmount", arg0)
}

// MaxAmount is a paid mutator transaction binding the contract method 0x94dee0a4.
//
// Solidity: function maxAmount(address ) returns(uint256)
func (_ITokenList *ITokenListSession) MaxAmount(arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.Contract.MaxAmount(&_ITokenList.TransactOpts, arg0)
}

// MaxAmount is a paid mutator transaction binding the contract method 0x94dee0a4.
//
// Solidity: function maxAmount(address ) returns(uint256)
func (_ITokenList *ITokenListTransactorSession) MaxAmount(arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.Contract.MaxAmount(&_ITokenList.TransactOpts, arg0)
}

// MinAmount is a paid mutator transaction binding the contract method 0x4d0a32db.
//
// Solidity: function minAmount(address ) returns(uint256)
func (_ITokenList *ITokenListTransactor) MinAmount(opts *bind.TransactOpts, arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.contract.Transact(opts, "minAmount", arg0)
}

// MinAmount is a paid mutator transaction binding the contract method 0x4d0a32db.
//
// Solidity: function minAmount(address ) returns(uint256)
func (_ITokenList *ITokenListSession) MinAmount(arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.Contract.MinAmount(&_ITokenList.TransactOpts, arg0)
}

// MinAmount is a paid mutator transaction binding the contract method 0x4d0a32db.
//
// Solidity: function minAmount(address ) returns(uint256)
func (_ITokenList *ITokenListTransactorSession) MinAmount(arg0 common.Address) (*types.Transaction, error) {
	return _ITokenList.Contract.MinAmount(&_ITokenList.TransactOpts, arg0)
}

// IWrappedCoinABI is the input ABI used to generate the binding from.
const IWrappedCoinABI = "[{\"constant\":false,\"inputs\":[],\"name\":\"deposit\",\"outputs\":[],\"payable\":true,\"stateMutability\":\"payable\",\"type\":\"function\"}]"

// IWrappedCoinFuncSigs maps the 4-byte function signature to its string representation.
var IWrappedCoinFuncSigs = map[string]string{
	"d0e30db0": "deposit()",
}

// IWrappedCoin is an auto generated Go binding around an Ethereum contract.
type IWrappedCoin struct {
	IWrappedCoinCaller     // Read-only binding to the contract
	IWrappedCoinTransactor // Write-only binding to the contract
	IWrappedCoinFilterer   // Log filterer for contract events
}

// IWrappedCoinCaller is an auto generated read-only Go binding around an Ethereum contract.
type IWrappedCoinCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IWrappedCoinTransactor is an auto generated write-only Go binding around an Ethereum contract.
type IWrappedCoinTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IWrappedCoinFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type IWrappedCoinFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IWrappedCoinSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type IWrappedCoinSession struct {
	Contract     *IWrappedCoin     // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// IWrappedCoinCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type IWrappedCoinCallerSession struct {
	Contract *IWrappedCoinCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts       // Call options to use throughout this session
}

// IWrappedCoinTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type IWrappedCoinTransactorSession struct {
	Contract     *IWrappedCoinTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts       // Transaction auth options to use throughout this session
}

// IWrappedCoinRaw is an auto generated low-level Go binding around an Ethereum contract.
type IWrappedCoinRaw struct {
	Contract *IWrappedCoin // Generic contract binding to access the raw methods on
}

// IWrappedCoinCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type IWrappedCoinCallerRaw struct {
	Contract *IWrappedCoinCaller // Generic read-only contract binding to access the raw methods on
}

// IWrappedCoinTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type IWrappedCoinTransactorRaw struct {
	Contract *IWrappedCoinTransactor // Generic write-only contract binding to access the raw methods on
}

// NewIWrappedCoin creates a new instance of IWrappedCoin, bound to a specific deployed contract.
func NewIWrappedCoin(address common.Address, backend bind.ContractBackend) (*IWrappedCoin, error) {
	contract, err := bindIWrappedCoin(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &IWrappedCoin{IWrappedCoinCaller: IWrappedCoinCaller{contract: contract}, IWrappedCoinTransactor: IWrappedCoinTransactor{contract: contract}, IWrappedCoinFilterer: IWrappedCoinFilterer{contract: contract}}, nil
}

// NewIWrappedCoinCaller creates a new read-only instance of IWrappedCoin, bound to a specific deployed contract.
func NewIWrappedCoinCaller(address common.Address, caller bind.ContractCaller) (*IWrappedCoinCaller, error) {
	contract, err := bindIWrappedCoin(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &IWrappedCoinCaller{contract: contract}, nil
}

// NewIWrappedCoinTransactor creates a new write-only instance of IWrappedCoin, bound to a specific deployed contract.
func NewIWrappedCoinTransactor(address common.Address, transactor bind.ContractTransactor) (*IWrappedCoinTransactor, error) {
	contract, err := bindIWrappedCoin(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &IWrappedCoinTransactor{contract: contract}, nil
}

// NewIWrappedCoinFilterer creates a new log filterer instance of IWrappedCoin, bound to a specific deployed contract.
func NewIWrappedCoinFilterer(address common.Address, filterer bind.ContractFilterer) (*IWrappedCoinFilterer, error) {
	contract, err := bindIWrappedCoin(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &IWrappedCoinFilterer{contract: contract}, nil
}

// bindIWrappedCoin binds a generic wrapper to an already deployed contract.
func bindIWrappedCoin(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(IWrappedCoinABI))
	if err != nil {
		return nil, err
	}
	return bind.NewBoundContract(address, parsed, caller, transactor, filterer), nil
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_IWrappedCoin *IWrappedCoinRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _IWrappedCoin.Contract.IWrappedCoinCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_IWrappedCoin *IWrappedCoinRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IWrappedCoin.Contract.IWrappedCoinTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_IWrappedCoin *IWrappedCoinRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _IWrappedCoin.Contract.IWrappedCoinTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_IWrappedCoin *IWrappedCoinCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _IWrappedCoin.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_IWrappedCoin *IWrappedCoinTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IWrappedCoin.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_IWrappedCoin *IWrappedCoinTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _IWrappedCoin.Contract.contract.Transact(opts, method, params...)
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_IWrappedCoin *IWrappedCoinTransactor) Deposit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IWrappedCoin.contract.Transact(opts, "deposit")
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_IWrappedCoin *IWrappedCoinSession) Deposit() (*types.Transaction, error) {
	return _IWrappedCoin.Contract.Deposit(&_IWrappedCoin.TransactOpts)
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_IWrappedCoin *IWrappedCoinTransactorSession) Deposit() (*types.Transaction, error) {
	return _IWrappedCoin.Contract.Deposit(&_IWrappedCoin.TransactOpts)
}
...
// TokenCashierFuncSigs maps the 4-byte function signature to its string representation.
var TokenCashierFuncSigs = map[string]string{
	"05d85eda": "count(address)",
	"0568e65e": "counts(address)",
	...
	"1cb928a9": "tokenLists(uint256)",
	"84378ec6": "tokenSafes(uint256)",
	"f2fde38b": "transferOwnership(address)",
	"3f4ba83a": "unpause()",
	"3ccfd60b": "withdraw()",
	"89476069": "withdrawToken(address)",
	"527ba9af": "wrappedCoin()",
}

// TokenCashierBin is the compiled bytecode used for deploying new contracts.
var TokenCashierBin = ""
